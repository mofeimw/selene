...
(defun helios/todo/view ()
  ...
  (let ((ungrouped (assoc nil helios/todo))
        (completed (assoc "completed" helios/todo/classified)))
    (helios/todo/view/render-group (cdr ungrouped))
